...
public class InsufficientCryptoChallengeFragment extends Fragment {
    ...
    private static final byte[] ENC_PART1 = {75, 69, 89, 123}; // KEY{
    ...
    private void toggleCompleteStatus() {
        boolean nowCompleted = progressTracker.toggleCompleted(FlagValidator.Module.INSUFFICIENT_CRYPTO_CHALLENGE);
    ...
    private void updateMarkCompleteFabAppearance(FloatingActionButton fabMarkComplete) {
        ...
        boolean isCompleted = progressTracker.isCompleted(FlagValidator.Module.INSUFFICIENT_CRYPTO_CHALLENGE);
