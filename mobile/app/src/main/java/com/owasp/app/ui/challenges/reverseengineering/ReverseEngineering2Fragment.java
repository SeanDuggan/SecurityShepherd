...
public class ReverseEngineering2Fragment extends Fragment {
    ...
    private void toggleCompleteStatus() {
        boolean nowCompleted = progressTracker.toggleCompleted(FlagValidator.Module.RE_CHALLENGE_2);
    ...
    private void updateMarkCompleteFabAppearance(FloatingActionButton fabMarkComplete) {
        ...
        boolean isCompleted = progressTracker.isCompleted(FlagValidator.Module.RE_CHALLENGE_2);
