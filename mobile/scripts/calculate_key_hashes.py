...
for module in ["RE_CHALLENGE_1", "RE_CHALLENGE_2", "RE_CHALLENGE_3",
               "IDS_CHALLENGE_1", "IDS_CHALLENGE_2",
               "POOR_AUTH_CHALLENGE", "SUPPLY_CHAIN_CHALLENGE",
               "INSECURE_COMM_CHALLENGE", "INSUFFICIENT_CRYPTO_CHALLENGE",
               "SECURITY_MISCONFIG_CHALLENGE_2", "SECURITY_MISCONFIG_CHALLENGE_3",
               "XSS_CHALLENGE", "CLIENT_SIDE_INJECTION_CHALLENGE_1", "CLIENT_SIDE_INJECTION_CHALLENGE_2"]:
    flag = flags[module]
    hash_value = sha256_hash(flag)
    print(f'put(Module.{module}, "{hash_value}");')
