...
import com.owasp.reverser.databinding.FragmentInsecureCommLessonBinding;
...
public class InsecureCommLessonFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding.showHintButton.setOnClickListener(v -> {
            Toast.makeText(getContext(), "Hint: Monitor logcat with tag 'NetworkTraffic' while clicking Send", Toast.LENGTH_LONG).show();
        });
    ...
    private void showDetailedInfo() {
        ...
        bestPracticesText.setText(getString(R.string.insecure_comm_best_practices));
        
        additionalSection.setVisibility(View.VISIBLE);
        additionalTitle.setText("🔒 HTTP vs HTTPS");
        additionalText.setText(getString(R.string.insecure_comm_http_https));
