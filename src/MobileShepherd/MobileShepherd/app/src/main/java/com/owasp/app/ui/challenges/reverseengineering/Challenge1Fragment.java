...
import com.owasp.app.databinding.FragmentChallenge1Binding;
...
public class Challenge1Fragment extends Fragment {
    ...
    private Challenge_1_Model challengeModel;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        challengeModel = new ViewModelProvider(this).get(Challenge_1_Model.class);
        ...
        btnValidate.setOnClickListener(v -> {
            ...
            if (challengeModel.validateFlag(userInput)) {
                textResult.setText(R.string.challenge1_success);
                textResult.setTextColor(Color.GREEN);
                textResult.setVisibility(View.VISIBLE);
            } else {
                textResult.setText(R.string.challenge1_failure);
