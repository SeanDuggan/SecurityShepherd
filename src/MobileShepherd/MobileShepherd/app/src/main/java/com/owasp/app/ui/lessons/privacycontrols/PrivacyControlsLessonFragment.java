...
public class PrivacyControlsLessonFragment extends Fragment {
    ...
    private static final String FLAG = "OWASP{3x1f_M3t4d4t4_L34k5_L0c4t10n}";
    ...
    private void showDetailedInfo() {
        ...
        android.widget.TextView bestPracticesText = dialogView.findViewById(R.id.best_practices_text);
        ...
        bestPracticesText.setText(R.string.privacy_lesson_best_practices);
