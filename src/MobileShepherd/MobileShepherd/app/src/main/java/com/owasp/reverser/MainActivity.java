...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_lesson, R.id.nav_insecure_data_lesson, R.id.nav_poor_auth_lesson, R.id.nav_supply_chain_lesson, R.id.nav_insecure_comm_lesson, R.id.nav_insufficient_crypto_lesson,
                R.id.nav_challenge_1, R.id.nav_challenge_2, R.id.nav_challenge_3,
                R.id.nav_insecure_data1, R.id.nav_insecure_data2, R.id.nav_insecure_data3, R.id.nav_insecure_data4,
