package com.owasp.reverser.ui.adb;
...
import com.owasp.reverser.databinding.FragmentAdbReferenceBinding;
...
public class AdbReferenceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        setupCopyButton(binding.copyPullFile, "adb pull /data/data/com.owasp.reverser/databases/Users.db");
        setupCopyButton(binding.copyPullSharedPrefs, "adb pull /data/data/com.owasp.reverser/shared_prefs/");
        setupCopyButton(binding.copyListFiles, "adb shell ls /data/data/com.owasp.reverser/");
        setupCopyButton(binding.copyListDatabases, "adb shell ls /data/data/com.owasp.reverser/databases/");
        
        setupCopyButton(binding.copySqlite, "adb shell sqlite3 /data/data/com.owasp.reverser/databases/Users.db");
        setupCopyButton(binding.copySqliteQuery, "sqlite> SELECT * FROM users;");
        setupCopyButton(binding.copyCat, "adb shell cat /data/data/com.owasp.reverser/shared_prefs/UserCredentials.xml");
        
        setupCopyButton(binding.copyGetPackages, "adb shell pm list packages | grep reverser");
        setupCopyButton(binding.copyPackagePath, "adb shell pm path com.owasp.reverser");
        setupCopyButton(binding.copyPullApk, "adb pull /data/app/com.owasp.reverser-*/base.apk");
        setupCopyButton(binding.copyClearData, "adb shell pm clear com.owasp.reverser");
