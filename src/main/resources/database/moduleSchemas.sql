...
DROP USER IF EXISTS 'userLookUuuup'@'localhost';
...
DROP USER IF EXISTS 'DnTPubUser'@'localhost';
...
DROP USER IF EXISTS 'DnTVipUser'@'localhost';
...
DROP USER IF EXISTS 'DnTPurUser'@'localhost';
...
DROP USER IF EXISTS 'firstBloodyMessL'@'localhost';
...
DROP USER IF EXISTS 'CharlieSeabrook'@'localhost';
...
DROP USER IF EXISTS 'RightGuard3d'@'localhost';
...
DROP USER IF EXISTS 'HdmiNoSignal'@'localhost';
...
DROP USER IF EXISTS 'randomUserName'@'localhost';
...
DROP USER IF EXISTS 'doveM3nCare'@'localhost';
...
DROP USER IF EXISTS 'murr4yFe1ld'@'localhost';
...
DROP USER IF EXISTS 'd3nn1sM4nely'@'localhost';
...
DROP USER IF EXISTS 'secureDood'@'localhost';
...
DROP USER IF EXISTS 'csrfChalEnuer'@'localhost';
...
DROP USER IF EXISTS 'l3tsg0cra'@'localhost';
...
DROP USER IF EXISTS 'csrfChalFour'@'localhost';
...
DROP USER IF EXISTS 'randomMoFoName'@'localhost';
...
DROP USER IF EXISTS 'randomFlower'@'localhost';
...
DROP USER IF EXISTS 'tSwsfUSer'@'localhost';
...
DROP USER IF EXISTS 'al1th3Tokens'@'localhost';
...
DROP USER IF EXISTS 'theBankMan'@'localhost';
...
DROP USER IF EXISTS 'procChalUser'@'localhost';
...
DROP USER IF EXISTS 'imVideoingThis'@'localhost';
